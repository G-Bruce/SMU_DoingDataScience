...
knitr::opts_knit$set(root.dir = '/Users/bgranger/Documents/SMU/DDS/SMU_DoingDataScience/Assignment_6_CaseStudy_1/DATA')
#'/Users/michaerl/Documents/SMU_DoingDataScience/Assignment_6_CaseStudy_1/DATA'
```
...
``` {r regionPlots, echo=TRUE, message=FALSE}
##library(ggplot2)
...
``` {r Placeholder_BoxPlots, echo=TRUE}
# BOXPLOTS ##############################################################
#IBU-ABV
ggplot(Breweries_Beers, aes(IBU, ABV)) +
  geom_boxplot() +
...
``` {r Placeholder_Histogram, echo=TRUE}
# HISTOGRAM ############################################################
#IBU
